  ...
  <div class="modal fade" id="modalRespuesta">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" id="responder" idSiguiente="" class="btn btn-primary" data-dismiss="modal">Responder</button>
          <button type="button" id="NopuedoResponder" idSiguiente="" class="btn btn-danger">No Puedo Responder</button>
        </div>
      </div>
    </div>
  </div>
